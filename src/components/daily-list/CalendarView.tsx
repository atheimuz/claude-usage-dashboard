                ...
                {cells.map((day, i) => {
                    ...
                    const cellContent = (
                        <div
                            ...
                            aria-label={
                                hasData
                                    ? `${month + 1}월 ${day}일 - ${dayReports!.length}건의 일지`
                                    : undefined
                            }
                            className={cn(
                                "flex w-10 aspect-square flex-col items-center justify-center rounded-md text-sm transition-colors",
                            ...
                            onKeyDown={
                                hasData ? (e) => handleCellKeyDown(e, dayReports!) : undefined
                            }
                        >
