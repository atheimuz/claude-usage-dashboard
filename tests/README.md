...
│   ├── monthly-list.spec.ts     # 월간 일지 목록 페이지 테스트
│   ├── monthly-detail.spec.ts  # 월간 일지 상세 페이지 테스트
...
│   ├── monthly-list.page.ts     # MonthlyListPage 클래스
│   └── monthly-detail.page.ts  # MonthlyDetailPage 클래스
├── mocks/                      # 목업 데이터
...
# 월간 일지 목록 테스트
npx playwright test tests/claude-usage-dashboard/monthly-list.spec.ts

# 월간 일지 상세 테스트
npx playwright test tests/claude-usage-dashboard/monthly-detail.spec.ts
...
- 월간 일지 상세 페이지 전체 (monthly-detail.spec.ts)
- 월간 일지 목록 페이지 리스트 뷰 (monthly-list.spec.ts)
